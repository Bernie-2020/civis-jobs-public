...
create or replace view van_sq_loads.sup_ids_{{ STATE }} as (
    ...
    from (
        ...
        select
            ...
            SPLIT_PART(ccj.st_myv_van_id, '-', 2) as van_id
          ...
          , upper(SPLIT_PART(ccj.st_myv_van_id, '-', 1)) as state_code

        from bernie_data_commons.contactcontacts_joined as ccj
        where upper(SPLIT_PART(ccj.st_myv_van_id, '-', 1)) = '{{ STATE }}'
            and ccj.st_myv_van_id is not null
